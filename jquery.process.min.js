...
window.setTimeout(function(){process[tuple[0]+"With"](jqXHR,args);},1);return this;};process[tuple[0]+"With"]=function(obj,args){if('notify'===tuple[0]&&'string'===typeof args[0]){args[0]=args[0].replace(' ','_');$.fn.trigger.apply($(obj),args);}
list.fireWith.apply(this,arguments);};});promise.promise(process);promise.promise(source!==null?source:{});if(init){init.call(process,process);}
