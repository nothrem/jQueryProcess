...
listProc.fireWith(process,args);list.fireWith(obj,args);return this;};});process.onCallback=function(event){return function(){process.notify.apply(process,[event].concat(Array.prototype.slice.call(arguments)));};};promise.promiseWith(process);promise.promise(source?source:{});if(init){init.call(process,process);}
